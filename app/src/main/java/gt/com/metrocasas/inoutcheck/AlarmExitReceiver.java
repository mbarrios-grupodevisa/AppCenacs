...
public class AlarmExitReceiver extends BroadcastReceiver {
    ...
    private static final int MY_NOTIFICATION_ID_EXIT = 1;
    @Override
    public void onReceive(Context context, Intent intent) {
        ...
        if(!dato.equals("Salida")) {
            ...
            myNotification = new Notification.Builder(context)
                    ...
                    .setContentText("No has realizado tu registro de salida.")
                    ...
                    .build();
            notificationManager.notify(MY_NOTIFICATION_ID_EXIT, myNotification);
        }
    }
}
